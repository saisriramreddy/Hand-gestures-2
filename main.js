...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/ya-iDyMnw/model.json',modelLoaded);
...
function speak(){
    ...
    speak_data_1="The gesture prediction is "+prediction_1;
